 ...
 */
public class WinningTeamAdapter extends ArrayAdapter<String[]> {
    ...
    public void writeBet (Team team) {
        ...
        firebase.child("Users").child(userName).child("winningTeam").setValue(team);
    }
}
